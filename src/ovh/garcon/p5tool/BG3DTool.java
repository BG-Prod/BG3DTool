...
public class BG3DTool implements Tool {
	Base base;
	...
	public void run() {
		if(this.running) {
			System.out.println("BG 3D Tool is already running.");
		} else {
			System.out.println("##tool.name## ##tool.prettyVersion## by ##author##");
			toolFrame = new BGViewer(this.getMenuTitle(), 800, 600);
